...
<section class="game-section">
    <div class="col_text">
        ...
        <label for="count">Search By Country</label>
        <select name="country" id="Country">
            <option disabled hidden selected>Search Country Name</option>
            <?php foreach ($countries as $country) { ?>
            <?php if ($country->slug !== 'marine-arts') { ?>
        ...
        <div class="col_artist">
            ...
            <a href="<?= site_url('marine-art') ?>" class="submit_btn"><input type="submit" class="submit_btn" placeholder="View Artist Gallery" value="View Artist Gallery"></a>
        </div>
    </div>
...
$(document).ready(function () {
    ...
    $(document).on( 'change', '#Country', function(e) {
        ...
        jQuery.ajax({
            ...
            data: { artist:artist, action:"get_artists_by_country"},
            dataType : 'json',
    ...
    $(document).on( 'change', '.artists', function(e) {
        ...
        jQuery.ajax({
            type: 'post',
            url: "<?= admin_url( 'admin-ajax.php' ); ?>",
            data: { artist:artist, action:"get_selected_artist"},
            dataType : 'json',
            success: function (response) {
                jQuery('body').waitMe('hide');
                // console.log(response.artistDesc);
