                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="mb-1">
                                                    ...
                                                    <select class="form-select" id="status" name="user_role" required>
                                                        ...
                                                        <option <?= isset($_GET['id']) && $user_role == "vendor"  ? 'selected' : '' ?> value="vendor">Vendor</option>
                                                        <!-- <option <?= isset($_GET['id']) && $user_role == "seller"  ? 'selected' : '' ?> value="seller">Seller</option> -->
                                                        <option <?= isset($_GET['id']) && $user_role == "customer"  ? 'selected' : '' ?> value="customer">Customer</option>
                                                    </select>
