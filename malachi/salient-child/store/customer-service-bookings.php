<?php /* Template Name: Customer Service Bookings */ ?>
<?php
$args = [
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td>
                                                <?= $value->post_status == 'publish' ? 'Completed' : 'Pending' ?>
                                               
                                            </td>

                                            <td>
                                                <a href="<?= home_url('service-invoice/?id='.$value->ID) ?>" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Invoice">
                ...
                jQuery.ajax({
                    ...
                    success: function(response) {
                        ...
                        if(!response.status){
                            ...
                            thiss.parents('td').html(response.shipping_status);
                        }
                    },
