...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    ...
                                    <h2 class="brand-text text-primary ms-1">Luxury Detailing</h2>
                                </a>

                                <h4 class="card-title mb-1">Welcome to Portal! 👋</h4>
                                <p class="card-text mb-2">Please sign-in to your account and start the adventure</p>

                                <form class="auth-login-form mt-2 basic_actions">
                                    <div class="mb-1">
                                        <label for="login-email" class="form-label">Email</label>
                                        <input type="text" class="form-control" id="login-email" name="user_email" placeholder="john@example.com" aria-describedby="login-email" tabindex="1" autofocus />
                                    </div>
    ...
    <script src="<?= get_stylesheet_directory_uri()  ?>/store/app-assets/js/scripts/pages/auth-login.js"></script>
    <!-- END: Page JS-->
    <script>
