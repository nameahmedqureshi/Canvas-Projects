<?php /* Template Name: Vendor Earnings */ ?>
<!DOCTYPE html>
                ...
                <section class="app-user-list">
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <h4 class="card-title">Seller Earnings</h4>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= $seller['TotalEarnings'] ?></td>
                                            <td><?= $seller['CurrentMonthEarnings'] ?></td>
                                            <td><?= $seller['TotalWithdrawals'] ?></td>
                                            <td><?= $seller['Total'] ?></td>
                                            <td><?= $seller['Status'] ?></td>
                                            <td>
                                                <a href="#!" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="View Invoice">
