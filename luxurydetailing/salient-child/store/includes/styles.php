...
if (!is_user_logged_in() || !current_user_can('manage_options')) {
    wp_redirect(home_url('our-services-2'));
    echo '<script>window.location = "'.home_url('our-services-2').'" </script>';
    exit;
}
...
<head>
    ...
    <title>Luxury Detailing | <?= $site_t ? $site_t : "" ?></title>
    <link rel="apple-touch-icon" href="<?= home_url('wp-content/uploads/2024/05/LDI-Logo.png') ?>">
    <link rel="shortcut icon" type="image/x-icon" href="<?= home_url('wp-content/uploads/2024/05/LDI-Logo.png') ?>">
