...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
                            ...
                            <div class="card-body">
                                ...
                                <form class="auth-forgot-password-form mt-2 basic_actions">
                                    <div class="mb-1">
                                        ...
                                        <input type="text" class="form-control" id="forgot-password-email" name="recovery_email" placeholder="john@example.com" aria-describedby="forgot-password-email" tabindex="1" autofocus />
                                    </div>
    ...
    <!-- END: Page Vendor JS-->
    <!-- BEGIN: Page JS-->
    <script src="<?= get_stylesheet_directory_uri()  ?>/store/app-assets/js/scripts/pages/auth-forgot-password.js"></script> <!-- END: Page JS-->
    <script>
