<?php /* Template Name: All Bookings */ ?>
<!DOCTYPE html>
                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?= $seller['BookingNo'] ?></td>
                                            <td><?= $seller['Name'] ?></td>
                                            <td><?= $seller['Vendor'] ?></td>
                                            <td><?= $seller['Customer'] ?></td>
                                            <td><?= $seller['TotalServiceAmount'] ?></td>
                                            <td><?= $seller['VendorReceived'] ?></td>
                                            <td><?= $seller['PaymentStatus'] ?></td>
                                            <td><?= $seller['ShippingStatus'] ?></td>
                                            <td>
