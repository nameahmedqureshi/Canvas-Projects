<?php /* Template Name: Appointment Manger */ ?>
<?php
                                ...
                                <tbody>
                                    ...
                                    // foreach ($orders->posts ?? [] as $key => $value) { 
                                        ...
                                        <tr>
                                            ...
                                            <td>test@test.com</td>
                                            <td>virtual</td>
                                            <td>Lorem Ispum Dummy</td>
                                            <!-- <td> <select class="form-control" id=""><option disabled selected>Pending</option> <option value="done">Complete</option> </select></td> -->
                                            <td>
                                                <a href="#" class="item-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit value Detail">View
                                                </a>
                                                <a href="#" class="item-session" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit value Detail">Ongoing Call
                                                </a>
                                            </td>
                                        </tr>
                                   <?php
