                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($services->posts ?? [] as $key => $value) {
                                        ...
                                        $service_type = get_post_meta($value->ID, 'servic_type', true);
                                        
                                    ?>

                                        <tr>
                                            <td><?= $value->ID ?></td>
                                            <td class="parent-title"><div class="d-flex justify-content-left align-items-center">
                                            ...
                                            <td><?= $service_type == 'in_person' ? 'In person' : ucfirst($service_type)  ?></td>
                                            <td>$<?= $price ?></td>
                                            <td><?=  get_post_meta($value->ID, 'status', true)   ?></td>

                                            <td>
                                                <a href="<?= home_url('add-new-service/?id='.$value->ID) ?>" class="item-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit value Detail">
