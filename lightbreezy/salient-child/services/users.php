...
<?php
$site_t = "User list";
$registered_roles = array('subscriber');
$args = array(
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="<?= home_url('add-new-user/?id=' . $user->ID) ?>" class="item_edit" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit">
