...
<link rel="stylesheet" type="text/css" href="<?= get_stylesheet_directory_uri()  ?>/services/app-assets/vendors/css/vendors.min.css">
    <link rel="stylesheet" type="text/css" href="<?= get_stylesheet_directory_uri()  ?>/services/app-assets/vendors/css/charts/apexcharts.css">
<!-- BEGIN: Body-->
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
   ...
   <?php include "includes/manu.php"; ?>
            ...
            <div class="content-body">
                ...
                <section id="dashboard-ecommerce">
                    <div class="row match-height">
                        ...
                        <!-- Statistics Card -->
                        <div class="col-xl-12 col-md-6 col-12" style="display: none;">
                            <div class="card card-statistics">
                                ...
                                <div class="card-body statistics-body">
                                    ...
                                    <?php 
                                        $data['PG1'] = ['bg' => 'primary', 'icon' => 'box'];
                                        $data['PG2'] = ['bg' => 'info', 'icon' => 'box'];
                                        $data['PG3'] = ['bg' => 'danger', 'icon' => 'box'];
                                        $data['PG4'] = ['bg' => 'success', 'icon' => 'box'];
                                        $data['PG5'] = ['bg' => 'warning', 'icon' => 'box'];
                                        $data['PG6'] = ['bg' => 'info', 'icon' => 'box'];
                                        ...
                                        foreach ($data as $key => $value) {
                                            ...
                                            <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0">
                                                <a class="d-flex flex-row" href="<?= home_url( 'all-orders/?garage=' ).$key ?>">
                                        ...
                                        <!-- <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-xl-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    ...
                                                    <p class="card-text font-small-3 mb-0">PG2 </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-sm-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    ...
                                                    <p class="card-text font-small-3 mb-0">PG3 </p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-sm-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    ...
                                                    <p class="card-text font-small-3 mb-0">PG4</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-sm-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    <h4 class="fw-bolder mb-0">$9745</h4>
                                                    <p class="card-text font-small-3 mb-0">PG5</p>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 col-sm-6 col-12 mb-2 mb-sm-0">
                                            <div class="d-flex flex-row">
                                                ...
                                                <div class="my-auto">
                                                    <h4 class="fw-bolder mb-0">$9745</h4>
                                                    <p class="card-text font-small-3 mb-0">PG6</p>
                                                </div>
                                            </div>
                                        </div> -->
                                    </div>
                                            ...
                                            <?php 
                                                function get_total_amount_sum_for_post_type($post_type) {
                                                    ...
                                                    $query = $wpdb->prepare("
                                                        ...
                                                        WHERE pm.meta_key = 'service_price'
                                                        AND p.post_type = %s
                                ...
                                <div class="row mx-0">
                                    <div class="col-md-12 col-12 revenue-report-wrapper">
                                        ...
                                        <?php 
                                            ...
                                            function get_total_amount_sum_by_month_for_current_year($post_type = 'orders', $meta_key = 'service_price') {
                                                global $wpdb;
                                            
                                                // Get the current year
                                                $current_year = date('Y');
                                            
                                                // Prepare the SQL query to get the sum of service_price grouped by month for the current year
                                                $query = $wpdb->prepare("
    ...
    <script src="<?= get_stylesheet_directory_uri()  ?>/services/app-assets/vendors/js/charts/apexcharts.min.js"></script>
    <script src="<?= get_stylesheet_directory_uri()  ?>/services/app-assets/js/core/app-menu.js"></script>
    <script src="<?= get_stylesheet_directory_uri()  ?>/services/app-assets/js/scripts/pages/dashboard-ecommerce.js"></script>
