...
$parent_category = get_term_by('slug', $_GET['cat'], 'product_cat');
if ($parent_category) {
        // Fetch all child terms of the main category
        ...
        // Retrieve all categories using the list of IDs
...
$type = isset($_GET['type']) ? rtrim($_GET['type'], '/') : '';
?>
