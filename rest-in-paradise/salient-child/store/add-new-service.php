...
if ( !in_array('administrator', wp_get_current_user()->roles) && !in_array('funeral_directory', wp_get_current_user()->roles) && !in_array('service_directory', wp_get_current_user()->roles) ) { 
                                        ...
                                        <div class="row">  
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="f-name" class="form-control" value="<?= $metaData['name'][0]  ?>" name="name" placeholder="Acquired Brain Injury" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    $serviceType = [
                                                        ...
                                                        // $serviceType = ['Auctioneers & Valuers','Bereavement Counselling','Caterers','Cemeteries and Memorial Parks','Charities','Civil & Humanist Funerals','Florists','Funeral Attire','Funeral Directors','Funeral Plans','Funeral Video & Streaming','Grave Maintenance','Grave Markers, Plaques & Ornaments','Headstones & Monuments','Homecare & Support','Hotels, Restaurants & Venues','House Clearance & Renovations','Memorial Cards & Keyrings','Repatriation','Singers and Musicians','Sympathy Cards & Memorial Gifts','Trace your Ancestors','Urns & Keepsakes'];
                                                    ?>
                                                    ...
                                                    <select name="service_type" class="form-select" id="service_type">
                                                        <?php foreach ($serviceType as $type): ?>
                                                            <option value="<?= esc_attr($type); ?>" <?= isset($metaData['service_type'][0]) && $metaData['service_type'][0] == $type ? 'selected' : ''; ?>>
                                                                <?= esc_html($type); ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="email" class="form-control" value="<?= $metaData['email'][0]   ?>" name="email" placeholder="www.oreillysfineart.com" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="phone" class="form-control" value="<?= $metaData['phone'][0]   ?>" name="phone" placeholder="+01 234 567" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="web_link" class="form-control" value="<?= $metaData['web_link'][0]   ?>" name="web_link" placeholder="www.oreillysfineart.com" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <input type="text" id="location" class="form-control" value="<?= $metaData['location'][0]   ?>" name="location" placeholder=" Georges St, Upper, Dun Laoghaire, Dublin, A96 R2V3" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <select name="country[]" class="form-select" id="country" multiple>
                                                        <?php foreach ($irishCounties as $country): ?>
                                                            <option value="<?= esc_attr($country); ?>" <?= !isset($metaData) ? 'selected' : ''; ?> <?= isset($metaData['country'][0]) && in_array($country, unserialize($metaData['country'][0])) ? 'selected' : ''; ?>>
                                                                <?= esc_html($country); ?>
                                                            </option>
                                                        <?php endforeach; ?>
                                                    </select>
                                            ...
                                            <div class="col-md-6">
                                                <div class="mb-1">
                                                    ...
                                                    <textarea type="text" id="short_description" rows="5" class="form-control" value="<?= $metaData['short_description'][0]   ?>" name="short_description" placeholder="Acquired Brain Injury Ireland (ABI Ireland) is Irelands leading provider"><?= $metaData['short_description'][0]   ?></textarea>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="hidden" value="add_update_service" name="action">
