...
<head>
    <title><?= get_the_title(get_the_ID())." | " ?>Rest In Paradise</title>
    <link rel="icon" type="image/x-icon" href="<?= home_url( 'wp-content/uploads/2025/01/cropped-footer-logo-192x192.png' )?>">
    <link rel="apple-touch-icon" href="<?= home_url( 'wp-content/uploads/2025/01/cropped-footer-logo-192x192.png' )?>" />
    <!-- BEGIN: Vendor CSS-->
...
<style>
    ...
    html.dark-layout img.dark-logo {
