<?php /* Template Name: All Family Notices */ ?>
<?php
$args = array(
                ...
                <section class="app-user-list">
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <h4 class="card-title">Family Notices</h4>
                        </div>
                            ...
                            <table class="datatables-basic table">
                                ...
                                <tbody>
                                    ...
                                    foreach ($services->posts ?? [] as $key => $value) {
                                        ...
                                        $categories = get_the_terms($value->ID, 'family-notice-category'); // Custom taxonomy fetch
                                        $category_names = (!empty($categories) && !is_wp_error($categories)) ? implode(', ', wp_list_pluck($categories, 'name')) : 'No Category';

                                        $authorFirstName = get_the_author_meta('first_name', $value->post_author);
                                        $authorLastName = get_the_author_meta('last_name', $value->post_author);
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            <td><?= $value->ID ?></td>
                                            <td>
                                                <a style="color: #000000;" href="<?= home_url( 'user-profile/?id='.$value->post_author ) ?>">
                                                    <div class="d-flex justify-content-left align-items-center">
                                                        <div class="d-flex flex-column">
                                                            <span class="emp_name text-truncate fw-bold"><?= $authorFirstName?></span>
                                                            <span class="emp_name text-truncate text-muted"><?= $authorLastName ?></span>
                                                        </div>
                                                    </div>
                                                </a>
                                            </td>
                                            ...
                                            <td>
                                                <!-- <a href="<?= home_url('add-new-family-notice?id='.$value->ID) ?>" class="item-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit value Detail">
