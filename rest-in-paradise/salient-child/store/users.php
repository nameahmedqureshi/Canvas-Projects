...
// $registered_roles = array('customer');
$args = array(
    'role__in'    => array($_GET['type']),
    'order'   => 'DESC'
);
                            ...
                            <table class="datatables-basic table">
                                <thead>
                                    <tr>
                                        ...
                                        <th>Name</th>
                                        <th>Email & Phone</th>
                                        <?php if($_GET['type'] == 'service_directory' ) { ?> <th>Subscription Status </th> <?php } ?>
                                        <th>Account Status </th>
                                        <th style="width: 63.875px;">Actions </th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-left align-items-center">
                                                    <!-- <div class="avatar  me-1"><img src="http://lms-coaching.test/assets/images/no-preview.png" alt="Avatar" width="32" height="32"></div> -->
                                                    <div class="d-flex flex-column">
                                                        <span class="emp_name text-truncate fw-bold"><?= $user->user_email ?></span>
                                                        <small class="emp_post text-truncate text-muted"><?= $usermeta['ph_num'][0] ?></small>
                                                    </div>
                                                </div>
                                            </td>
                                            <?php if($_GET['type'] == 'service_directory' ) { ?> <td class="<?= $subscription ?>"><?= $usermeta['membership_status'][0] ?></td> <?php } ?>
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <label class="form-check-label mb-50 user_status" for="account_switch"><?= $usermeta['account_status'][0] ?></label>
                                                    <div class="form-check form-check-primary form-switch">
                                                        <input type="checkbox" class="form-check-input" data-id="<?= $user->ID ?>" id="account_switch" <?=  $usermeta['account_status'][0]  == 'Active' ? 'checked' : '' ?>>
                                                    </div>
                                                </div>
                                            </td>
                                
                                            <td>
                                                <a href="<?= home_url('user-profile/?id=' . $user->ID. '&type='. $_GET['type']) ?>" class="item_edit" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit">
