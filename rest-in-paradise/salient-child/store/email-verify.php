                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="<?= home_url() ?>" class="brand-logo">
                                    <img class="stnd skip-lazy default-logo dark-version" alt="Kainamo" src="https://devu17.testdevlink.net/Malachi_Hydrick/wp-content/uploads/2024/10/FF-01-001-2048x1328.png">                                
