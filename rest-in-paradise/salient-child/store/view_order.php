...
//     $customer = $order->get_meta('_customer');
//     $userdata = get_userdata( $customer );
// } else {
//     $vendor = $order->get_meta('main_order');
//     $userdata = get_userdata( $vendor  );
// }
// var_dump($customer);
// var_dump($vendor);
// var_dump($userdata);
            ...
            <div class="row invoice-preview">
                    ...
                    <div class="card invoice-preview-card">
                            ...
                            <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                <div>
                                    <div class="logo-wrapper">
                                        <img class="dark-logo" alt="Kainamo" src="https://devu17.testdevlink.net/Malachi_Hydrick/wp-content/uploads/2024/10/FF-01-001-2048x1328.png">
                                        <img class="light-logo" alt="Kainamo" src="https://devu17.testdevlink.net/Malachi_Hydrick/wp-content/uploads/2024/10/FFF-001-002.png"> 
                                        <!-- <img src="<?= $directory_url ?>/assets/images/logo.png" alt="" width="80px" height="80px"> -->
                                        <!-- <h3 class="invoice-logo">Kainamo</h3> -->

                                    </div>
                                    <p class="card-text mb-25"><span class="fw-bold">Email: </span> <?= esc_html($customer_email); ?></p>
                                    <p class="card-text mb-0"><span class="fw-bold">Phone: </span> <?= esc_html($customer_phone); ?></p>
                                </div>
                                <div class="mt-md-0 mt-2">
                                    ...
                                    <div class="invoice-date-wrapper">
                                        ...
                                        <select class="form-select" name="status" id="status">
                                            <?php 
                                            $exclude_status = ['wc-cancelled', 'wc-refunded', 'wc-failed', 'wc-checkout-draft', 'wc-processing', 'wc-on-hold'];
                        ...
                        <div class="table-responsive">
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php   $matching_items = []; // Array to store items that match the category
                                        ...
                                        <td class="py-1">
                                            <div class="order_item_main">
                                                ...
                                                <div class="order_title">
                                                    ...
                                                    <p class="card-text text-nowrap"><span></p>
                                                </div>
                                            </div>
                                        </td>
                                        <td class="py-1">
                                ...
                                <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                    <div class="invoice-total-wrapper">
                                        <!-- <div class="invoice-total-item">
                                            ...
                                            <p class="invoice-total-amount"><?= wc_price($item_total); ?></p>
                                        </div> -->
                                        <div class="invoice-total-item">
                                        ...
                                        <div class="invoice-total-item">
                                            ...
                                            <p class="invoice-total-amount">$<?=  number_format(array_sum($order_total), 2);  ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                    <div class="card">
                        <div class="card-body">
                            <?php if ( !in_array('customer', wp_get_current_user()->roles) ) { ?>
                                <button type="submit" class="btn btn-primary w-100 mb-75" name="update_order">Update</button>
                            <?php } ?>
                            <a class="btn w-100 mb-75 btn btn-primary w-100 mb-75 waves-effect waves-float waves-light" href="<?= home_url('print-invoice?id='.$order_id.'&type=product') ?>" target="_blank"> Print </a>

                            <a class="btn btn-primary w-100 mb-75" href="<?= home_url('product-orders/?type='.$_GET['type'])?>">Back</a>
                        </div>
                    </div>
...
?>
    ...
    $(document).ready(function () {
            ...
            updateButton.click(function (e) {
                ...
                // const customer_id  = <?php echo $customer; ?>;
            ...
            //     // var idFromUrl = new URLSearchParams(window.location.search).get('order_id');
