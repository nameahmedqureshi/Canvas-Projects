<?php /* Template Name: Seller Transactions */ ?>
                                    ...
                                    if (class_exists('WooCommerce')) {
                                        ...
                                        if (!empty($orders)) {
                                            foreach ($orders as $order) {
                                                ...
                                                echo '<tr>';
                                                echo '<td class="order_name fw-bold">#' . esc_html($order_id) . '</td>';
                                                echo '<td class="purchased_name">' . esc_html($purchased_items) . '</td>';
                                                echo '<td class="customer_name">' . esc_html($customer_name) . '</td>';
                                                echo '<td class="order_total fw-bold">' . number_format($order_total, 2) . '</td>';
