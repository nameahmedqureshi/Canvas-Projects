<?php /* Template Name: All Death Notices */ ?>
<?php
$args = array(
                ...
                <section class="app-user-list">
                    ...
                    <div class="card">
                        <div class="card-body border-bottom">
                            <h4 class="card-title">Death Notices</h4>
                        </div>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td><?= date('jS M Y', strtotime($metaData['death_date'][0]));  ?></td>
                                            <td><?= get_the_date('jS M Y', $value->ID);  ?></td>
                                            ...
                                            <td>
                                                <a href="<?= home_url('add-new-death-notice?id='.$value->ID) ?>" class="item-edit" data-bs-toggle="tooltip" data-bs-placement="top" title="" data-bs-original-title="Edit value Detail">
