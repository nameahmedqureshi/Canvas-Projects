...
<!--                                    
                        ...
                        <div class="email-app-details show">
                            ...
                            <?php if (!$announcements->found_posts) { ?>
                                <div class="no-announcement"><p>No Announcements</p></div>
                            <?php } ?>
                        ...
                        <div class="modal fade" id="compose-mail" tabindex="-1" aria-hidden="true">
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body pb-5 px-sm-5 pt-50">
                                        <div class="text-center mb-2">
                                            <h1 class="mb-1">Make Announcement</h1>
                        ...
                        <!-- make announcement -->
                        <div class="modal modal-sticky" id="cdompose-mail" data-bs-keyboard="false">
