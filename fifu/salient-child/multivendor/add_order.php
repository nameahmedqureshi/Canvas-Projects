...
<?php
    ...
    $_post_author = $order->get_meta('_post_author');
?>
    <style>
        h2.order_item {
            margin-left: 30px;
                        ...
                        <div class="card-body invoice-padding pb-0">
                            <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                <div>
                                    ...
                                    <!-- <p class="card-text mb-25"><span class="fw-bold">Payment via: </span> <?= esc_html($payment_method); ?></p> -->
                                    <p class="card-text mb-25"><span class="fw-bold">Email: </span> <?= esc_html($customer_email); ?></p>
                                    <p class="card-text mb-0"><span class="fw-bold">Phone: </span> <?= !empty($customer_phone) ? esc_html($customer_phone) : 'XXXXXX'; ?></p>
                                </div>
                                <div class="mt-md-0 mt-2">
                                    ...
                                    <?php if ( !in_array('restaurant', wp_get_current_user()->roles) && !isset($_GET['type']) ) { ?>
                                    <div class="invoice-date-wrapper">
                            ...
                            <div class="row invoice-spacing">
                                ...
                                <div class="col-xl-4 p-0 mt-xl-0 mt-2">
                                    ...
                                    <table>
                                        <tbody>
                                            <tr>
                                                <td class="pe-1">Total Pay:</td>
                                                <td><span class="fw-bold">€<?= number_format($order_total, 2); ?></span></td>
                                            </tr>
                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <?php foreach ( $items as $item_id => $item ) {
                                        ...
                                        $purchased_user_id = get_post_field('post_author', $item->get_product_id());
                                ...
                                <div class="col-md-6 d-flex justify-content-end order-md-2 order-1">
                                    <div class="invoice-total-wrapper">
                                        ...
                                        <div class="invoice-total-item">
                                            ...
                                            <p class="invoice-total-amount"><?= number_format($order_total, 2);  ?></p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-xl-3 col-md-4 col-12 invoice-actions mt-md-0 mt-2">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <?php if ( !in_array('restaurant', wp_get_current_user()->roles) && !isset($_GET['type']) ) { ?>
                                <input type="hidden" id="user" value="<?= $purchased_user_id ?>">
                                <button type="submit" class="btn btn-primary w-100 mb-75" name="update_order">Update</button>
                            <?php } ?>
                            <?php //$back_url = in_array('administrator', wp_get_current_user()->roles) || in_array('seller', wp_get_current_user()->roles) ? home_url('orders/') : home_url('customer-orders/')  ?>
                            <a class="btn btn-primary w-100 mb-75" href="<?= isset($_GET['type']) ?  home_url('orders/?type=purchased') : home_url('orders/')  ?>">Back</a>
                        </div>
                    </div>
                </div>
            </div>
