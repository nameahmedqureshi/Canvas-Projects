                                    ...
                                    if (class_exists('WooCommerce')) {
                                        ...
                                        if(in_array('administrator',wp_get_current_user()->roles)){
                                            $args['meta_query'] = [
                                                [
                                                    'key' => 'usertype',
                                                    'value' => array('supplier', 'farmer', 'restaurant'),
                                                    'compare' => 'IN'
                                                ]
                                            ];
                                        ...
                                        // elseif(in_array('restaurant',wp_get_current_user()->roles)){
                                        //     $args['meta_query'] = [
                                        //         [   
                                        //             'key' => 'customer_id',
                                        ...
                                        if (!empty($orders)) {
                                            foreach ($orders as $order) {
                                                ...
                                                $order_status =  $order_status == 'composite' ? 'processing' : $order->get_status();
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="order_date"><?= esc_html($order_date) ?></td>
                                                    ...
                                                    <td class="order_total fw-bold"><?= wp_kses_post(wc_price($order_total)) ?></td>
                                                    <td class="earnings fw-bold"><?= wp_kses_post(wc_price($order_total)) ?></td>
                                                    <td>
                                                        <a href="<?= esc_url( home_url('order-details/?order_id=' . $order_id . (isset($_GET['type']) ? '&type=purchased' : '')) ) ?>" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="View Order">View Order</a>
                                                    </td>
