<?php /* Template Name: Supplier Subscription Packages */ ?>
<?php
  $supplier_basic_plan = get_option('supplier_basic_plan', true);
  $supplier_advanced_plan = get_option('supplier_advanced_plan', true);
  $supplier_premium_plan = get_option('supplier_premium_plan', true);
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div id="basic-plan" class="content" role="tabpanel" aria-labelledby="basic-plan-trigger">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" name="basic_plan_title" value="<?=  $supplier_basic_plan['plan_title'] ?>" id="basic_plan_title" class="form-control" placeholder="Plan Title" />
                                        </div>
                                        <div class="mb-1 col-12">
                                            <label for="basic_short_desc">Add Description:</label>
                                            <textarea class="form-control" id="basic_short_desc" value="<?= $supplier_basic_plan['short_desc'] ?>" name="basic_short_desc" rows="4" cols="50"><?= 
                                           $supplier_basic_plan['short_desc'] ?></textarea>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="basic_annual_price">Annual Price *</label>
                                            <input type="number" name="basic_annual_price" value="<?=  $supplier_basic_plan['annual_price'] ?>" id="basic_annual_price" class="form-control" placeholder="Annual Price" aria-label="Annual Price" />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="basic_monthly_price">Monthly Price *</label>
                                            <input type="number" name="basic_monthly_price" value="<?=  $supplier_basic_plan['monthly_price'] ?>" id="basic_monthly_price" class="form-control" placeholder="Monthly Price" aria-label="Monthly Price" />
                                        </div>
                                    </div>
                                ...
                                <div id="advanced-plan" class="content" role="tabpanel" aria-labelledby="advanced-plan-trigger">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" name="advanced_plan_title" value="<?=  $supplier_advanced_plan['plan_title'] ?>" id="advanced_plan_title" class="form-control" placeholder="Plan Title" />
                                        </div>
                                        <div class="mb-1 col-12">
                                            <label for="advanced_short_desc">Add Description:</label>
                                            <textarea class="form-control" id="advanced_short_desc" value="<?=  $supplier_advanced_plan['short_desc'] ?>" name="advanced_short_desc" rows="4" cols="50"><?= 
                                            $supplier_basic_plan['short_desc'] ?></textarea>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="advanced_annual_price">Annual Price *</label>
                                            <input type="number" name="advanced_annual_price" value="<?=  $supplier_advanced_plan['annual_price'] ?>" id="advanced_annual_price" class="form-control" placeholder="Annual Price" aria-label="Annual Price" />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="advanced_monthly_price">Monthly Price *</label>
                                            <input type="number" name="advanced_monthly_price" value="<?=  $supplier_advanced_plan['monthly_price'] ?>" id="advanced_monthly_price" class="form-control" placeholder="Monthly Price" aria-label="Monthly Price" />
                                        </div>
                                    </div>
                                ...
                                <div id="premium-plan" class="content" role="tabpanel" aria-labelledby="premium-plan-trigger">
                                    ...
                                    <div class="row">
                                        <div class="mb-1 col-md-12">
                                            ...
                                            <input type="text" name="premium_plan_title" value="<?=  $supplier_premium_plan['plan_title'] ?>" id="premium_plan_title" class="form-control" placeholder="Plan Title" />
                                        </div>
                                        <div class="mb-1 col-12">
                                            <label for="premium_short_desc">Add Description:</label>
                                            <textarea class="form-control" id="premium_short_desc" value="<?=  $supplier_premium_plan['short_desc'] ?>" name="premium_short_desc" rows="4" cols="50"><?= 
                                            $supplier_advanced_plan['short_desc'] ?></textarea>
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="premium_annual_price">Annual Price *</label>
                                            <input type="number" name="premium_annual_price" value="<?= $supplier_premium_plan['annual_price'] ?>" id="premium_annual_price" class="form-control" placeholder="Annual Price" aria-label="Annual Price" />
                                        </div>
                                        <div class="mb-1 col-md-6">
                                            <label class="form-label" for="premium_monthly_price">Monthly Price *</label>
                                            <input type="number" name="premium_monthly_price" value="<?= $supplier_premium_plan['monthly_price'] ?>" id="premium_monthly_price" class="form-control" placeholder="Monthly Price" aria-label="Monthly Price" />
                                        </div>
                                    </div>
                                    <div class="d-flex justify-content-between">
