...
<nav class="header-navbar navbar navbar-expand-lg align-items-center floating-nav navbar-light navbar-shadow container-xxl">
        <div class="navbar-container d-flex content">
            ...
            <ul class="nav navbar-nav align-items-center ms-auto">
                <li class="nav-item d-none d-lg-block"><?= $membership_status == 'trialing' ? '<span class="trial">TRIAL</span>' : '' ?></li>
                ...
                <li class="nav-item dropdown dropdown-notification me-25">
                    ...
                    <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                        ...
                        <li class="scrollable-container media-list">
                            ...
                            ?>
                            <a class="d-flex" href="<?= stripos($title, 'membership') !== false ? '!#' : home_url('order-details/?order_id='.$order_number)  ?>">
                ...
                <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="#" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="user-nav d-sm-flex d-none"><span class="user-name fw-bolder"><?= !empty($full_name) ? $full_name : $user->display_name ?></span><span class="user-status"><?= $roles ?></span></div><span class="avatar"><img class="round" src="<?= !empty($image_url) ? $image_url :   $directory_url.'/assets/images/avatar.png' ?>" alt="avatar" height="40" width="40"><span class="avatar-status-online"></span></span>
                    </a>
                    <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                        <a class="dropdown-item" href="<?= home_url('setting/') ?>"><i class="me-50" data-feather="user"></i> Profile</a>
