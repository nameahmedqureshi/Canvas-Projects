                    ...
                    <div class="col-lg-6 col-md-6 col-12">
                        <div class="card card-congratulation-medal">
                            <div class="card-body">
                                ...
                                <p class="card-text font-small-3 fw-bolder">£<?= $sumThisMonth ?> earnings in the last 30 days</p>
                                <p class="card-text font-small-3 fw-bolder">Earnings this month so far</p>
                                <h3 class="mb-75 mt-2 pt-50">
                                    <p>£<?= $sumThisMonth ?></p>
                                </h3>
                            </div>
                                            ...
                                            if (class_exists('WooCommerce')) {
                                                ...
                                                if(in_array('administrator',wp_get_current_user()->roles)){
                                                    ...
                                                    $args = array(
                                                        ...
                                                        'meta_query' => array(
                                                            array(
                                                                'key' => 'usertype',
                                                                'value' => wp_get_current_user()->roles[0],
                                                                'compare' => '='
                                                            )
                                                        )
                                                    );
                                                ...
                                                if (!empty($orders)) {
                                                    foreach ($orders as $order) {
                                                        ...
                                                        echo '<td class="earnings fw-bold">' . wp_kses_post(wc_price($order_total)) . '</td>';
