...
if(isset($_GET['id'])){
    ...
    $stock_type = get_post_meta( $_GET['id'] , 'stock_type', true);
...
//  echo "<pre>";
// var_dump($_product->manage_stock);
...
<style>
    .close {
        ...
        top: 120px;       /* Adjusts the distance from the top */
        right: 50px;     /* Adjusts the distance from the right */
    ...
    .close a {
        ...
        background-color: #577226 !important; /* Prominent red background */
        color: #ffffff;           /* White icon color */
        font-size: 20px;          /* Adjust icon size */
        padding: 10px 15px;       /* Adds spacing around the icon */
        border-radius: 50%;       /* Makes it circular */
        box-shadow: 0px 4px 6px rgba(0, 0, 0, 0.2); /* Adds a shadow for prominence */
        transition: all 0.3s ease; /* Adds a smooth hover effect */
    }

    .close a:hover {
        background-color: #ff6b81; /* Slightly lighter red on hover */
...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="">
                    ...
                    <div class="bs-stepper vertical wizard-modern modern-vertical-wizard-example">
                        ...
                        <div class="bs-stepper-content">
                            <form id="submitProduct"  enctype="multipart/form-data">
                                <div class="close"><a href="<?= site_url('product') ?>"><i data-feather='x'></i></a></div>
                                    ...
                                    <!-- <form class="product_detail"> -->
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6">
                                                ...
                                                <span>This will be the price per quantity</span>
                                            </div>
                                            <div class="mb-1 col-md-6">
                                            ...
                                            <div class="mb-1 col-md-6 stock_quantity_div"  >
                                                <label class="form-label">Select Stock Type</label>
                                                <select name="stock_type" id="stock_type" class="form-select">
                                                    <option value="liters" <?= $stock_type == 'liters' ? 'selected' : '' ?>>Liters</option>
                                                    <option value="kilograms" <?= $stock_type == 'kilograms' ? 'selected' : '' ?>>Kilograms</option>
                                                    <option value="boxes" <?= $stock_type == 'boxes' ? 'selected' : '' ?>>Boxes</option>
                                                </select>
                                            </div>
                                            ...
                                            if( in_array('administrator', wp_get_current_user()->roles)  ){ 
                                                ...
                                                <div class="mb-1 col-md-6 user">
                                                    ...
                                                    <select name="user_type" class="form-select" id="select_user_type">
                                                        ...
                                                        <option value="farmer" <?= $selected_user_type == 'farmer' ? 'selected' : '' ?>>Farmer</option>
                                                        <option value="supplier" <?= $selected_user_type == 'supplier' ? 'selected' : '' ?>>Supplier</option>
                                                    </select>
                                                </div>
                                                <div class="mb-1 col-md-6 user">
                                    ...
                                    <!-- <form class="product_detail"> -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="mb-1 col-md-6 stock_quantity_div">
                                                ...
                                                <input type="text"  value="<?=  $stock_type ?>" id="view_stock_type" class="form-control" placeholder="liters" readonly />

                                            </div>

                                            <div class="mb-1 col-md-6 stock_quantity_div"  >
                                                <label class="form-label" for="total_quantity"> Total Quantity</label>
                                                <input type="number"  value="<?=  $_product->stock_quantity ?>" id="view_total_quantity" class="form-control" placeholder="0" readonly />
                                            </div>
                                            ...
                                            <!-- <div class="mb-1 col-md-6 stock_quantity_div" <?= isset($_GET['id']) && $_product->manage_stock == 'yes' ? 'style="display:block"' : 'style="display:none"' ?> >
                                                <label class="form-label">Select Stock Type</label>
                                            ...
                                            <div class="mb-1 col-md-12 backorders_div"  <?= isset($_GET['id']) && $_product->manage_stock == 'yes' ? 'style="display:block"' : 'style="display:none"' ?> >
                                            ...
                                            <div class="mb-1 col-md-12 stock_status_div" <?= isset($_GET['id']) && $_product->manage_stock == 'yes' ? 'style="display:none"' : 'style="display:block"' ?>>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('change', '#stock_type, #total_quantity', function(e) {
                let stock_type = $('#stock_type').val();
                let total_quantity =  $('#total_quantity').val();
                $('#view_stock_type').val(stock_type);
                $('#view_total_quantity').val(total_quantity);
