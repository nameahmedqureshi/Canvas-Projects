...
<body class="vertical-layout vertical-menu-modern blank-page navbar-floating footer-static  " data-open="click" data-menu="vertical-menu-modern" data-col="blank-page">
    ...
    <!-- BEGIN: Content-->
    <!-- invoice type -->
    <?php if(isset($_GET['type']) &&  $_GET['type'] == 'invoice') {
                ...
                <div class="invoice-print p-3">
                    <div class="invoice-header d-flex justify-content-between flex-md-row flex-column pb-2">
                        <div>
                            <div class="d-flex mb-1">
                                ...
                                <h3 class="text-primary invoice-logo">Julianna Moda</h3>
                            </div>
                        ...
                        <div class="mt-md-0 mt-2">
                            <h4 class="fw-bold text-end mb-1">INVOICE #<?= $id ?></h4>
                            ...
                            <div class="invoice-date-wrapper">
                                ...
                                <span class="fw-bold"><?= $status == 'paid' ? 'Paid' : 'Unpaid' ?></span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row pb-2">
                        ...
                        <div class="col-sm-6 mt-sm-0 mt-2">
                            <h6 class="mb-1">Invoice Details:</h6>
                            <table>
                                <tbody>
                                    <tr>
    ...
    <!-- BEGIN: Content-->
    <!-- order type -->
    <?php if(isset($_GET['type']) &&  $_GET['type'] == 'order') {
